  ...
  return (
    <div>
      ...
      <div
        ...
        className={`${
          toggle ? "flex" : "hidden"
        } overflow-y-auto overflow-x-hidden rounded-lg fixed top-0 right-0 left-0 z-50 justify-center items-center w-screen h-screen md:inset-0 bg-slate-600 bg-opacity-50`}
      >
        <div className="relative max-w-xl opacity-100 text-slate-700">
          <div className="relative rounded-lg shadow bg-slate-100">
            ...
            <div className="p-4 md:p-5 max-h-[60vh] overflow-y-scroll">
